...
<template>
  ...
  >
    <div class="relative">
      <img class="hidden dark:block" :width="size" :height="size" alt="NocoDB" src="~/assets/img/logo1.png" />
      <img class="dark:hidden" :width="size" :height="size" alt="NocoDB" src="~/assets/img/logo1.png" />
